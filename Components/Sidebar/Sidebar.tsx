...
export default function Sidebar({extended = false} : {extended?: boolean}) {
    return (
        <aside className={`absolute trns shadow-lg flex flex-col gap-1 p-4 min-w-1/3 bg-gray-200 right-0 bottom-0 translate-y-full ${extended ? "translate-x-0" : "translate-x-full"}`}>
